    ...
    <div>
      ...
      <div className="nav2">
        ...
        <div className="input_box">
          <input className="input_search" value={stateSearch}
          onChange={(e)=> setSearch(e.target.value)}></input>
          <img src={Search} alt="" className="search_icon" />
        </div>

        <div sx={{ m: 5, display: "flex", justifyContent: "space-between" }} className="icons">
          <FavoriteBorderIcon sx={{ color: "grey" }} />
          <img src={cart} alt="" sx={{ mb: "4px", width: '22px' }} className="cart" />корзина</div>
